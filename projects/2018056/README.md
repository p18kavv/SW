...
| 2 | [Γραμμή εντολών](https://epidrome.github.io/teaching/cli) (systemd) και [διαδικασία συνεργασίας με pull request στον οργανισμό της ομάδας σας](https://epidrome.github.io/teaching/team) |[`Παραδοτέο 2`]() | Πραγματοποίησα το 2ο παραδοτέο, εγκαθιστώντας τα Arch Linux στον υπολογιστή μου. |
